<div class="footer p-a dker">
	<div class="row">
		<div class="col-md-3">
			...
			<div class="m-v-md">
				<p class="text-muted">Bootstrap 4 web application ui kit for your next project, with 9 categories, 6 layouts and 100+ components.</p>
			</div>
		</div>
		<div class="col-md-6 text-primary-hover">
			<div class="row m-t-md">
				...
				<div class="col-sm-4">
					<h6 class="text-u-c m-b">About</h6>
					<div class="m-b-md">
						<ul class="nav l-h-2x">
							<li class="nav-item">
